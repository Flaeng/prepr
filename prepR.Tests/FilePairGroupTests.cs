...
public class FilePairGroupTests
{
    ...
    public void ComputeFilePairs_TwoFilesOneBlock_OnePair()
    {
        ...
        var result = new ScanResult([block], 2, 100, new Dictionary<string, int>(), new Dictionary<string, NestingDepthInfo>(), new Dictionary<string, IReadOnlyList<EarlyReturnViolation>>(), new Dictionary<string, int>(), new Dictionary<string, IReadOnlyList<MagicNumberViolation>>(), new Dictionary<string, IReadOnlyList<MagicStringViolation>>(), new Dictionary<string, int>());
        var pairs = FilePairGroup.ComputeFilePairs(result);
