...
public class SummaryStatisticsTests
{
    ...
    public void Compute_SingleBlock_CorrectStats()
    {
        ...
        var result = new ScanResult([block], 3, 100, new Dictionary<string, int>(), new Dictionary<string, NestingDepthInfo>(), new Dictionary<string, IReadOnlyList<EarlyReturnViolation>>(), new Dictionary<string, int>(), new Dictionary<string, IReadOnlyList<MagicNumberViolation>>(), new Dictionary<string, IReadOnlyList<MagicStringViolation>>(), new Dictionary<string, int>());
        var stats = SummaryStatistics.Compute(result);
    ...
    public void Compute_MultipleBlocks_MostDuplicatedFile()
    {
        ...
        var result = new ScanResult([block1, block2], 3, 200, new Dictionary<string, int>(), new Dictionary<string, NestingDepthInfo>(), new Dictionary<string, IReadOnlyList<EarlyReturnViolation>>(), new Dictionary<string, int>(), new Dictionary<string, IReadOnlyList<MagicNumberViolation>>(), new Dictionary<string, IReadOnlyList<MagicStringViolation>>(), new Dictionary<string, int>());
        var stats = SummaryStatistics.Compute(result);
    ...
    public void Compute_ThreeFilesShareBlock_CountsAllFiles()
    {
        ...
        var result = new ScanResult([block], 3, 150, new Dictionary<string, int>(), new Dictionary<string, NestingDepthInfo>(), new Dictionary<string, IReadOnlyList<EarlyReturnViolation>>(), new Dictionary<string, int>(), new Dictionary<string, IReadOnlyList<MagicNumberViolation>>(), new Dictionary<string, IReadOnlyList<MagicStringViolation>>(), new Dictionary<string, int>());
        var stats = SummaryStatistics.Compute(result);
