...
public class HtmlReporterTests
{
    ...
    public void Report_HtmlEncodesContent()
    {
        ...
        var result = new ScanResult([block], 2, 10, new Dictionary<string, int>(), new Dictionary<string, NestingDepthInfo>(), new Dictionary<string, IReadOnlyList<EarlyReturnViolation>>(), new Dictionary<string, int>(), new Dictionary<string, IReadOnlyList<MagicNumberViolation>>(), new Dictionary<string, IReadOnlyList<MagicStringViolation>>(), new Dictionary<string, int>());
    ...
    public void Report_IndentationOverage_ContainsPromptButtons()
    {
        ...
        {
            ["/src/Deep.cs"] = new(8, new List<(int, int)> { (42, 8) })
        };
        var block = new DuplicateBlock(
            ["var x = 1;", "var y = 2;", "var z = 3;", "Console.WriteLine(x);", "Console.WriteLine(y);"],
            [
        ...
        var result = new ScanResult([block], 1, 50,
            ...
            nestingDepths,
            new Dictionary<string, IReadOnlyList<EarlyReturnViolation>>(), new Dictionary<string, int>(), new Dictionary<string, IReadOnlyList<MagicNumberViolation>>(), new Dictionary<string, IReadOnlyList<MagicStringViolation>>(), new Dictionary<string, int>());
