...
public class FileDuplicationInfoTests
{
    ...
    public void ComputePerFile_WithDuplicates_ReturnsSeverity()
    {
        ...
        var result = new ScanResult([block], 2, 20, new Dictionary<string, int>(), new Dictionary<string, NestingDepthInfo>(), new Dictionary<string, IReadOnlyList<EarlyReturnViolation>>(), new Dictionary<string, int>());
        var infos = DuplicationFileInfo.ComputePerFile(result, new ReportOptions());
    ...
    public void ComputePerFile_MediumSeverity()
    {
        ...
        var result = new ScanResult([block], 2, 40, new Dictionary<string, int>(), new Dictionary<string, NestingDepthInfo>(), new Dictionary<string, IReadOnlyList<EarlyReturnViolation>>(), new Dictionary<string, int>());
        var infos = DuplicationFileInfo.ComputePerFile(result, new ReportOptions());
    ...
    public void ComputePerFile_LowSeverity()
    {
        ...
        var result = new ScanResult([block], 2, 200, new Dictionary<string, int>(), new Dictionary<string, NestingDepthInfo>(), new Dictionary<string, IReadOnlyList<EarlyReturnViolation>>(), new Dictionary<string, int>());
        var infos = DuplicationFileInfo.ComputePerFile(result, new ReportOptions());
    ...
    public void ComputePerFile_SortedByDuplicationPercentageDescending()
    {
        ...
        var result = new ScanResult([block], 2, 110, new Dictionary<string, int>(), new Dictionary<string, NestingDepthInfo>(), new Dictionary<string, IReadOnlyList<EarlyReturnViolation>>(), new Dictionary<string, int>());
        var infos = DuplicationFileInfo.ComputePerFile(result, new ReportOptions());
