...
public class OverIndentedFileInfoTests
{
    ...
    public void Compute_NoViolations_ReturnsEmpty()
    {
        ...
        var result = new ScanResult([], 2, 80, new Dictionary<string, int>(), nestingDepths, new Dictionary<string, IReadOnlyList<EarlyReturnViolation>>(), new Dictionary<string, int>(), new Dictionary<string, IReadOnlyList<MagicNumberViolation>>(), new Dictionary<string, IReadOnlyList<MagicStringViolation>>(), new Dictionary<string, int>());
        var rule = new IndentationRule(null, 5);
    ...
    public void Compute_ReportsFilesOverLimit()
    {
        ...
        var result = new ScanResult([], 3, 380, new Dictionary<string, int>(), nestingDepths, new Dictionary<string, IReadOnlyList<EarlyReturnViolation>>(), new Dictionary<string, int>(), new Dictionary<string, IReadOnlyList<MagicNumberViolation>>(), new Dictionary<string, IReadOnlyList<MagicStringViolation>>(), new Dictionary<string, int>());
        var rule = new IndentationRule(null, 5);
        var options = new ReportOptions(IndentationRule: rule);
    ...
    public void Compute_PathSpecificRules_ApplyCorrectLimits()
    {
        ...
        var result = new ScanResult([], 2, 120, new Dictionary<string, int>(), nestingDepths, new Dictionary<string, IReadOnlyList<EarlyReturnViolation>>(), new Dictionary<string, int>(), new Dictionary<string, IReadOnlyList<MagicNumberViolation>>(), new Dictionary<string, IReadOnlyList<MagicStringViolation>>(), new Dictionary<string, int>());
        var rules = new Dictionary<string, int>
        {
            { "src/FolderA", 3 },
            { "src/FolderA/FolderB", 5 }
    ...
    public void Compute_FileAtExactLimit_NotReported()
    {
        ...
        var result = new ScanResult([], 1, 100, new Dictionary<string, int>(), nestingDepths, new Dictionary<string, IReadOnlyList<EarlyReturnViolation>>(), new Dictionary<string, int>(), new Dictionary<string, IReadOnlyList<MagicNumberViolation>>(), new Dictionary<string, IReadOnlyList<MagicStringViolation>>(), new Dictionary<string, int>());
        var rule = new IndentationRule(null, 5);
        var options = new ReportOptions(IndentationRule: rule);
