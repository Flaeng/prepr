...
internal static class HtmlRuleSectionWriter
{
    ...
    internal static void WriteLineLimitRule(ScanResult result, string rootPath, TextWriter writer, ReportOptions options)
    {
        ...
        else
        {
            ...
            foreach (var v in overLimit)
            {
                ...
                writer.WriteLine($"""<tr><td class="px-6 py-4 font-mono text-xs text-primary break-all">{WebUtility.HtmlEncode(relativePath)}</td><td class="px-6 py-4 text-right font-bold text-tertiary">{v.LineCount}</td><td class="px-6 py-4 text-right text-on-surface-variant">{v.Limit}</td>{SeverityCell(v.Severity)}<td class="px-6 py-4 text-right whitespace-nowrap"><button data-prompt="{prompt}" onclick="showPromptModal(this)" class="px-2 py-1 rounded text-[10px] font-bold bg-primary/10 text-primary border border-primary/20 hover:bg-primary/20 transition-colors mr-1" style="cursor:pointer">Show prompt</button><button data-prompt="{prompt}" onclick="copyPrompt(this)" class="px-2 py-1 rounded text-[10px] font-bold bg-primary/10 text-primary border border-primary/20 hover:bg-primary/20 transition-colors" style="cursor:pointer">Copy prompt</button></td></tr>""");
            }
    ...
    internal static void WriteIndentationRule(ScanResult result, string rootPath, TextWriter writer, ReportOptions options)
    {
        ...
        else
        {
            ...
            for (int i = 0; i < overIndented.Count; i++)
            {
                ...
                writer.WriteLine($"""<tr><td class="px-6 py-3 font-mono text-[11px] text-primary break-all">{WebUtility.HtmlEncode(relativePath)}</td><td class="px-6 py-3 text-right font-bold text-tertiary">{v.MaxDepth}</td><td class="px-6 py-3 text-right text-on-surface-variant">{v.RangesDisplay}</td><td class="px-6 py-3 text-right text-on-surface-variant">{v.Limit}</td>{SeverityCell(v.Severity)}<td class="px-6 py-3 text-right whitespace-nowrap"><button onclick="document.getElementById('{codeId}').classList.toggle('hidden')" class="px-2 py-1 rounded text-[10px] font-bold bg-primary/10 text-primary border border-primary/20 hover:bg-primary/20 transition-colors mr-1" style="cursor:pointer">Show code</button><button data-prompt="{prompt}" onclick="showPromptModal(this)" class="px-2 py-1 rounded text-[10px] font-bold bg-primary/10 text-primary border border-primary/20 hover:bg-primary/20 transition-colors mr-1" style="cursor:pointer">Show prompt</button><button data-prompt="{prompt}" onclick="copyPrompt(this)" class="px-2 py-1 rounded text-[10px] font-bold bg-primary/10 text-primary border border-primary/20 hover:bg-primary/20 transition-colors" style="cursor:pointer">Copy prompt</button></td></tr>""");
    ...
    internal static void WriteEarlyReturnRule(ScanResult result, TextWriter writer, string rootPath, ReportOptions options)
    {
        ...
        else
        {
            ...
            for (int fi = 0; fi < violations.Count; fi++)
            {
                ...
                writer.WriteLine($"""<tr class="hover:bg-primary/5 transition-colors"><td class="px-6 py-3 font-mono text-[11px] text-primary break-all">{relativePath}</td><td class="px-6 py-3 text-right font-bold text-tertiary">{file.Violations.Count}</td>{SeverityCell(file.Severity)}<td class="px-6 py-3 text-right whitespace-nowrap"><button onclick="document.getElementById('{codeId}').classList.toggle('hidden')" class="px-2 py-1 rounded text-[10px] font-bold bg-primary/10 text-primary border border-primary/20 hover:bg-primary/20 transition-colors mr-1" style="cursor:pointer">Show code</button><button data-prompt="{prompt}" onclick="showPromptModal(this)" class="px-2 py-1 rounded text-[10px] font-bold bg-primary/10 text-primary border border-primary/20 hover:bg-primary/20 transition-colors mr-1" style="cursor:pointer">Show prompt</button><button data-prompt="{prompt}" onclick="copyPrompt(this)" class="px-2 py-1 rounded text-[10px] font-bold bg-primary/10 text-primary border border-primary/20 hover:bg-primary/20 transition-colors" style="cursor:pointer">Copy prompt</button></td></tr>""");
    ...
    internal static void WriteCommentDensityRule(ScanResult result, string rootPath, TextWriter writer, ReportOptions options)
    {
        ...
        else
        {
            ...
            foreach (var v in violations)
            {
                var relativePath = Path.GetRelativePath(rootPath, v.FilePath);
                var prompt = WebUtility.HtmlEncode(v.GetPrompt(relativePath));
                writer.WriteLine($"""<tr><td class="px-6 py-4 font-mono text-xs text-primary break-all">{WebUtility.HtmlEncode(relativePath)}</td><td class="px-6 py-4 text-right font-bold text-tertiary">{v.CommentLines}</td><td class="px-6 py-4 text-right text-on-surface-variant">{v.TotalLines}</td>{SeverityCell(v.Severity)}<td class="px-6 py-4 text-right whitespace-nowrap"><button data-prompt="{prompt}" onclick="showPromptModal(this)" class="px-2 py-1 rounded text-[10px] font-bold bg-primary/10 text-primary border border-primary/20 hover:bg-primary/20 transition-colors mr-1" style="cursor:pointer">Show prompt</button><button data-prompt="{prompt}" onclick="copyPrompt(this)" class="px-2 py-1 rounded text-[10px] font-bold bg-primary/10 text-primary border border-primary/20 hover:bg-primary/20 transition-colors" style="cursor:pointer">Copy prompt</button></td></tr>""");
            }
    ...
    internal static void WriteMagicNumberRule(ScanResult result, string rootPath, TextWriter writer, ReportOptions options)
    {
        ...
        else
        {
            ...
            for (int i = 0; i < violations.Count; i++)
            {
                ...
                writer.WriteLine($"""<tr><td class="px-6 py-4 font-mono text-xs text-primary break-all">{WebUtility.HtmlEncode(relativePath)}</td><td class="px-6 py-4 text-right font-bold text-tertiary">{file.Violations.Count}</td><td class="px-6 py-4 text-right text-on-surface-variant">{file.Limit}</td>{SeverityCell(file.Severity)}<td class="px-6 py-4 text-right whitespace-nowrap"><button onclick="document.getElementById('{codeId}').classList.toggle('hidden')" class="px-2 py-1 rounded text-[10px] font-bold bg-primary/10 text-primary border border-primary/20 hover:bg-primary/20 transition-colors mr-1" style="cursor:pointer">Show code</button><button data-prompt="{prompt}" onclick="showPromptModal(this)" class="px-2 py-1 rounded text-[10px] font-bold bg-primary/10 text-primary border border-primary/20 hover:bg-primary/20 transition-colors mr-1" style="cursor:pointer">Show prompt</button><button data-prompt="{prompt}" onclick="copyPrompt(this)" class="px-2 py-1 rounded text-[10px] font-bold bg-primary/10 text-primary border border-primary/20 hover:bg-primary/20 transition-colors" style="cursor:pointer">Copy prompt</button></td></tr>""");
    ...
    internal static void WriteFolderFilesRule(ScanResult result, string rootPath, TextWriter writer, ReportOptions options)
    {
        ...
        writer.Write($"""
            ...
            <div class="flex items-center gap-4">
            <div class="h-8 w-1 bg-primary"></div>
            <h2 class="font-headline text-3xl font-bold text-on-surface uppercase tracking-tight">Folder File Count</h2>
            {SeverityBadges(highCount, mediumCount, lowCount)}
            </div>
            <span class="material-symbols-outlined transition-transform group-open:rotate-180">expand_more</span>
            </summary>
        ...
        else
        {
            ...
            <th class="px-6 py-3 text-right">Files</th>
            <th class="px-6 py-3 text-right">Limit</th>
            <th class="px-6 py-3">Severity</th>
            <th class="px-6 py-3 text-right">Actions</th>
            </tr>
            ...
            foreach (var v in violations)
            {
                ...
                var prompt = WebUtility.HtmlEncode(v.GetPrompt(relativePath));
                writer.WriteLine($"""<tr><td class="px-6 py-4 font-mono text-xs text-primary break-all">{WebUtility.HtmlEncode(relativePath)}</td><td class="px-6 py-4 text-right font-bold text-tertiary">{v.FileCount}</td><td class="px-6 py-4 text-right text-on-surface-variant">{v.Limit}</td>{SeverityCell(v.Severity)}<td class="px-6 py-4 text-right whitespace-nowrap"><button data-prompt="{prompt}" onclick="showPromptModal(this)" class="px-2 py-1 rounded text-[10px] font-bold bg-primary/10 text-primary border border-primary/20 hover:bg-primary/20 transition-colors mr-1" style="cursor:pointer">Show prompt</button><button data-prompt="{prompt}" onclick="copyPrompt(this)" class="px-2 py-1 rounded text-[10px] font-bold bg-primary/10 text-primary border border-primary/20 hover:bg-primary/20 transition-colors" style="cursor:pointer">Copy prompt</button></td></tr>""");
            }
